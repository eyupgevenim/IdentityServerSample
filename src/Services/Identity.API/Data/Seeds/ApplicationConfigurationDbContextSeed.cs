...
{
    public class ApplicationConfigurationDbContextSeed
    {
        public async Task SeedAsync(ApplicationConfigurationDbContext context, IConfiguration configuration)
        {
            ...
            clientUrls.Add("TodoApi", configuration.GetValue<string>("TodoApiClient"));
            ...
            {
                foreach (var scop in Config.ApiScopes())
